use bevy::{color::palettes::css::{DARK_GRAY, GREEN, RED}, prelude::*, utils::HashMap, window::WindowResolution};
use rand::Rng;
...
fn main() {
    ...
    app.add_systems(Startup, (spawn_score, spawn_camera, spawn_players, spawn_ball, spawn_border));
